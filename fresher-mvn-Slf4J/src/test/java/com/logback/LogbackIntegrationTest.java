...
public class LogbackIntegrationTest {
    ...
    public void givenLogHierarchy_MessagesFiltered() {
        ...
        Logger parentLogger =
                (Logger) LoggerFactory.getLogger("com.baeldung.logback");

        parentLogger.setLevel(Level.INFO);

        Logger childlogger = (Logger)LoggerFactory.getLogger("com.baeldung.logback.tests");
    ...
    public void givenParameters_ValuesLogged() {
        ...
        Logger logger = (Logger) LoggerFactory.getLogger(LogbackIntegrationTest.class);
    ...
    public void givenConfig_MessageFiltered() {
        ...
        Logger foobar = (Logger) LoggerFactory.getLogger("com.baeldung.foobar");
        Logger logger = (Logger) LoggerFactory.getLogger("com.baeldung.logback");
        Logger testslogger = (Logger) LoggerFactory.getLogger("com.baeldung.logback.tests");
